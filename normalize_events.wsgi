...
site.addsitedir('~/var/www/' + app_name + '/venv/bin/python/lib/python3.4/site-packages')
...
activate_env = os.path.expanduser('/var/www/' + app_name + '/venv/bin/python/bin/activate_this.py')
